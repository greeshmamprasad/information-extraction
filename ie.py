...
def getWeapon(article):
    ...
    weapons["BOMB"] = ["BOMB", "BOMBS", "AERIAL BOMB ", "BOMB", "BOMBS", "CARBOMB", "CAR BOMB",
    ...
    weapons["DYNAMITE"] = ["DYNAMITE", "DYNAMITE-ATTACK", "DYNAMITE-ATTACKS", "DYNAMITE ATTACK", "DYNAMITE ATTACKS",
                           "DYNAMITE STICK", "DYNAMITE STICKS",
                           "DYNAMITE-STICK", "DYNAMITE-STICKS", "DYNAMITES", "DYNAMITE CHARGE"]

    weapons["EXPLOSIVE"] = ["EXPLOSIVE", "EXPLOSIVES", "VEHICLE LOADED WITH EXPLOSIVES", "EXPLOSIVE DEVICE",
    ...
    weapons["MISC"] = ["STONES", "ARTILLERY", "FIREARM","PROJECTILE", "TNT", "RDX"]
...
def getOrganization(article):
    ...
    organizations["ARENA"] = ["ARENA", "THE ARENA [NATIONALIST REPUBLICAN ALLIANCE]","ARENA [NATIONALIST REPUBLICAN ALLIANCE]", "NATIONALIST REPUBLICAN ALLIANCE"]
    organizations["ELN"] = ['THE NATIONAL LIBERATION ARMY',"ELN [ARMY OF NATIONAL LIBERATION]", "THE ARMY OF NATIONAL LIBERATION","ARMY OF NATIONAL LIBERATION", "ELN","COLOMBIAN GUERRILLA GROUP","NATIONAL LIBERATION ARMY","THE GUERRILLA ARMY OF NATIONAL LIBERATION","PRO-CASTROITE ARMY OF NATIONAL LIBERATION"]
    ...
    organizations["POLICE"] = ["SALVADORAN POLICE", "NATIONAL POLICE", "COLOMBIAN POLICE", "POLICE"]
    organizations["ARMY"] = ["CRISTIANI'S GOVERNMENT","FORCES OF THE CRISTIANI ADMINISTRATION", "ARMY/SALVADORAN ARMY MILITARY SCHOOL","SALVADORAN ARMED FORCES", "ARMED FORCES", "SALVADORAN TOP MILITARY COMMAND","THE MILITARY FASCIST DICTATORSHIP","ULTRALEFTIST GROUPS","SALVADORAN ARMED FORCES","MILITARY OFFICERS", "EIGHT MILITARY OFFICERS","ATLACATL BATTALION", "ARMED FORCES","ARMY","ARMED FORCES' GENERAL STAFF", "ARMED FORCES", "GENERAL STAFF","SALVADORAN ARMY","GOVERNMENT", "GOVERNMENT AND ARMY", "GOVERNMENT AND ARMY SECTORS"]
    organizations["RIGHTWING"] = ["EXTREME RIGHT-WING ASSASSINATION GROUP", "FAR RIGHTWING", "RIGHTWING","DEATH SQUAD", "ASSASSINATION GROUP"]
